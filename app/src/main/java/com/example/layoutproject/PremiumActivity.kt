...
class PremiumActivity : AppCompatActivity() {
    ...
    private fun setupView() {
        val data: GoPremium = GoPremium("Go Premium","Get unlimited access!", "$11.99", "$4.99", "$143.99 per year", "$11.99 per month", "$59.99 per year", "$4.99 per month", "Monthly", "Yearly")
        binding.goPremium = data
    }
}
